  ...
  <div class="col-md-8 col-12 mr-auto ml-auto">
    ...
    <div class="wizard-container">
      <div class="card card-wizard" data-color="rose" id="wizard">
        <form action="{!! route('report_generate_pembelian') !!}" method="GET" target="blank_" id="formCetakLaporan">
          <!--        You can switch " data-color="primary" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
          <div class="card-header text-center">
            <h3 class="card-title">
              Format Tampilan Laporan Pembelian
            </h3>
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="periode_laporan">
                <h5 class="info-text"> Pilih periode penampilan laporan pembelian!</h5>
